          ...
          <>
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider text-[#52525B] mb-1.5">Estado</p>
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider text-[#52525B] mb-1.5">Prioridad</p>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-zinc-50 border border-zinc-200 rounded-sm p-3">
                  <p className="text-xs font-bold uppercase tracking-wider text-[#52525B]">Valor</p>
                  <p className="text-2xl font-extrabold tracking-tighter text-[#0A0A0A] mt-1">{money(lead.value)}</p>
                </div>
                <div>
                  <p className="text-xs font-bold uppercase tracking-wider text-[#52525B] mb-1.5">Responsable</p>
              ...
              {/* Tasks */}
              <div>
                <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[#52525B] mb-2"><CheckSquare className="h-3.5 w-3.5" /> Tareas</p>
                <div className="space-y-1.5">
                  {(lead.tasks || []).length === 0 && <p className="text-sm text-zinc-400">Aún no hay tareas.</p>}
                  {(lead.tasks || []).map((t) => (
              ...
              {/* Notes */}
              <div>
                <p className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[#52525B] mb-2"><StickyNote className="h-3.5 w-3.5" /> Notas internas</p>
