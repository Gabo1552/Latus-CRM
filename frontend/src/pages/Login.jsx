    ...
    <div className="min-h-screen flex bg-[#F9F9F7]">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-xs tracking-[0.2em] uppercase font-bold text-[#52525B] mb-3">Bienvenido de nuevo</p>
          <h2 className="text-3xl font-extrabold tracking-tighter text-[#0A0A0A] mb-2">Ingresá a Latus CRM</h2>
          ...
          <p className="text-xs text-[#52525B] mt-6 leading-relaxed">
            El primer usuario en ingresar se convierte en <span className="font-semibold text-[#0A0A0A]">Administrador</span> del espacio. Los datos de demostración ya están cargados.
          </p>
        </div>
      </div>
    </div>
